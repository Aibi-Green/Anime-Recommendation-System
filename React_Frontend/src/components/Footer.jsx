    ...
    <footer className='flex justify-between px-32 py-16 bg-secondary-200 text-primary'>
      <div className='pr-20'>
        <h1 className='text-xl font-bold transition-colors hover:text-tertiary-200'>
          <Link to={MainPages.HOME}>NutriMatch</Link>
        </h1>
        <div className='whitespace-pre-wrap'>“Eat Smart<br/> Live Healthy”</div>
        <div className='mt-1 text-xs'>&copy; 2024 NutriMatch. All rights reserved.</div>
      </div>
