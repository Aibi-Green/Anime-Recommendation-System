  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center items-center gap-4 py-12 w-full min-h-screen">
        <p className="mb-4 w-2/3 mx-auto text-secondary-200 text-center">Nutrimatch is a Personalized Nutrition Website. In case of emergencies and other concerns, please refer to the following hotlines:</p>
        ...
        <HotlineCard image={nat_center} title="National Center for Physical Health Crisis" number="1553" />
